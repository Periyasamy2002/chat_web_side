...
urlpatterns = [
    ...
    path("group-info/<str:code>/", views.group_info, name="group_info"),
    ...
    path("group/<str:code>/load-more/", views.load_more_messages, name="load_more_messages"),
    ...
    path("admin/translation-metrics/", views.get_translation_metrics, name="translation_metrics"),
